...
export const EXCHANGE_ACTIONS = {
  ...
  INIT_PAYMENT_INSTANT_BUY: 'INIT_PAYMENT_INSTANT_BUY',
  GET_AUTHORISE_INFO: 'GET_AUTHORISE_INFO',
  ...
  GET_LIST_OFFER_PRICE_CASH_ATM: 'GET_LIST_OFFER_PRICE_CASH_ATM',
  ...
  GET_CASH_FROM_CRYPTO: 'GET_CASH_FROM_CRYPTO',
  SEND_ATM_CASH_TRANSFER: 'SEND_ATM_CASH_TRANSFER',
  CANCEL_ATM_CASH_TRANSFER: 'CANCEL_ATM_CASH_TRANSFER',
  GET_TRANSACTION_CASH_STORE: 'GET_TRANSACTION_CASH_STORE',
  UPLOAD_RECIEPT_ATM_CASH_TRANSFER: 'UPLOAD_RECIEPT_ATM_CASH_TRANSFER',
  GET_CASH_CENTER_BANK: 'GET_CASH_CENTER_BANK',
  ...
  GET_REVIEW_BUY_COIN: 'GET_REVIEW_BUY_COIN',
};

export const cancelAtmCashTransfer = createAPI(EXCHANGE_ACTIONS.CANCEL_ATM_CASH_TRANSFER);

export const getCashCenterBankInfo = createAPI(EXCHANGE_ACTIONS.GET_CASH_CENTER_BANK);

export const uploadReceipAtmCashTransfer = createAPI(EXCHANGE_ACTIONS.UPLOAD_RECIEPT_ATM_CASH_TRANSFER);

export const sendAtmCashTransfer = createAPI(EXCHANGE_ACTIONS.SEND_ATM_CASH_TRANSFER);

export const getCashFromCrypto = createAPI(EXCHANGE_ACTIONS.GET_CASH_FROM_CRYPTO);
...
export const initPaymentInstantBuy = createAPI(EXCHANGE_ACTIONS.INIT_PAYMENT_INSTANT_BUY);
export const getAuthoriseInfo = createAPI(EXCHANGE_ACTIONS.GET_AUTHORISE_INFO);
...
export const getListOfferPriceCashAtm = createAPI(EXCHANGE_ACTIONS.GET_LIST_OFFER_PRICE_CASH_ATM);
...
export const getTransactionCashStore = createAPI(EXCHANGE_ACTIONS.GET_TRANSACTION_CASH_STORE);
...
export const getReviewBuyCoin = createAPI(EXCHANGE_ACTIONS.GET_REVIEW_BUY_COIN);
