export default {
  ...
  'ex.create.label.amountSell': 'Maximum per sale',
  'ex.create.label.amountSell.update': 'New limit per sale',
  'ex.create.label.sell.currentBalance': 'Current limit per sale',
  'ex.create.label.buy.currentBalance': 'Current limit per purchase',
  ...
  'ex.create.label.beASeller.update': 'Update selling info',
  'ex.create.label.beABuyer': 'You can also be a buyer',
  'ex.create.label.beABuyer.update': 'Update buying info',
  ...
  FAQ_DATA: [
    ...
    },
    {
      ...
      answer: 'Yes. Guru only accepts ETH for now, but support will be added for other currencies very soon.',
    },
    {
      question: 'How do I start with Guru?',
      isList: true,
      answer: [
        {
          title: 'Get Ether:',
    ...
    },
    {
      ...
      answer: 'Guru will soon have a completely decentralized solution for verifying the outcome and incentivizing truth telling (a DAO of reporters!). In the meantime, as we will launch just in time for the FIFA world cup, our team will use a public source (livescore.com) and act as the reporter.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Guru requires no downloads, and no sign ups. That means no passwords, no phone numbers and no emails. 100% anonymity.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Very soon, Guru will apply to everything under the sun. The only limitation will be your creativity. You can easily create any market on any future event, be it sports, politics, science, markets, climate… you name it.',
    },
    {
      question: 'What’s gonna happen to the Handshake mobile app?',
      answer: 'We will be integrating Handshake (and your favourite features like promises, IOUs, contract upload, etc.) into the Guru mobile website.',
    },
  ],
