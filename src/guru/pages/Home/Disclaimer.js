...
export default class Disclaimer extends React.PureComponent {
  ...
  render() {
    return (
      <div className={Disclaimer.displayName}>
        ...
        By choosing to use Ninja, the user accepts sole responsibility for their behavior and agrees to abide by the legalities of their governing jurisdiction.
